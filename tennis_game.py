...
def main():
    global b_x, b_y, b_muki, idx, mb, muki_x_r, muki_y_r, r, score, diffculty, level
    pygame.init()
    ...
    while True:
        ...
        if idx == 0: #title
            ...
            score_h = font_s_j.render("点数:"+str(score)+"　　レベル:"+str(level), True, BLACK)
            screen.blit(score_h, [800, 10])
            ...
            if tmr % lu_k == 0 and tmr != 0:
                ...
                screen.blit(lu, [10, 10])
                level = level + 1
                l_se.play()
                b_hayasa = tmr / lu_k * lu_d + 5
            ...
            score_h = font_s_j.render("点数:"+str(score)+"　　レベル:"+str(level), True, WHITE)
            screen.blit(score_h, [800, 10])
